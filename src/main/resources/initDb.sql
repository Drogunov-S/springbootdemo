...
-- CREATE TYPE ROLE_ENUM AS ENUM ('ROLE_GUEST', 'ROLE_USER', 'ROLE_ADMIN');
CREATE TABLE person
(
    ...
    role       VARCHAR(30) DEFAULT 'ROLE_GUEST'
);
INSERT INTO
...
VALUES
  ...
  , ( 'Алексеев Алексей Алексеевич', 'Alex', 'AleX', 1989, 'brow2341@mail.ru'
    , 'USA, California, 230506, Wood street 7', 'ROLE_GUEST')
  , ( 'Познер Владимир Владимирович', 'Vladim', 'pozdnev', 1944, 'Dr-r@i.com'
    , 'Parish, London, 134215, Elfi street 33', 'ROLE_GUEST')
